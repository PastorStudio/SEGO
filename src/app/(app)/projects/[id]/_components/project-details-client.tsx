                  ...
                  {tasks.length > 0 ? (
                    tasks.map((task) => (
                      <TableRow key={task.id}>
                        ...
                        <TableCell>
                          <Badge variant={taskStatusVariant[task.status]}>{taskStatusTranslate[task.status]}</Badge>
                        </TableCell>
                        <TableCell className="text-right">
                          <ClientDate value={task.dueDate} />
                        </TableCell>
                      </TableRow>
                    ))
                  ) : (
                  ...
                  {warehouseRequests.length > 0 ? (
                    warehouseRequests.map((req) => (
                      <TableRow key={req.id}>
                        ...
                        <TableCell>
                          <Badge variant={requestStatusVariant[req.status]}>{requestStatusTranslate[req.status]}</Badge>
                        </TableCell>
                        <TableCell className="text-center">{req.items.length}</TableCell>
                        <TableCell className="text-right">
                          <ClientDate value={req.requiredByDate} />
                        </TableCell>
                      </TableRow>
                    ))
                  ) : (
                    <TableRow>
                      <TableCell colSpan={4} className="text-center">
                        No hay solicitudes a almacén para este proyecto.
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
